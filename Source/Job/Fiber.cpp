...
#	pragma section(".text")
__declspec(allocate(".text")) static u8 SetContextCode[] = {
	0x4c, 0x8b, 0x01,								//
	0x48, 0x8b, 0x61, 0x08,							//
	0x48, 0x8b, 0x59, 0x10,							//
	0x48, 0x8b, 0x69, 0x18,							//
	...
	0x44, 0x0f, 0x10, 0x89, 0x80, 0x00, 0x00, 0x00, //
	0x44, 0x0f, 0x10, 0x91, 0x90, 0x00, 0x00, 0x00, //
	0x44, 0x0f, 0x10, 0x99, 0xa0, 0x00, 0x00, 0x00, //
	0x44, 0x0f, 0x10, 0xa1, 0xb0, 0x00, 0x00, 0x00, //
	0x44, 0x0f, 0x10, 0xa9, 0xc0, 0x00, 0x00, 0x00, //
	0x44, 0x0f, 0x10, 0xb1, 0xd0, 0x00, 0x00, 0x00, //
	0x44, 0x0f, 0x10, 0xb9, 0xe0, 0x00, 0x00, 0x00, //
	0x41, 0x50,										//
	0x31, 0xc0,										//
	0xc3											//
};
...
void (*SetContext)(FiberContext* to) = reinterpret_cast<void (*)(FiberContext*)>(&(*SetContextCode));
